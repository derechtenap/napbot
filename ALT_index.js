...
var XMLHttpRequest = require('xmlhttprequest').XMLHttpRequest,leaderboard_id = 3;
const xhr = new XMLHttpRequest();
const prefix = config.prefix;

var urlAPI = 'https://aoe2.net/api/leaderboard?game=aoe2de&leaderboard_id=' + leaderboard_id + '&search=';
...
client.on('message', message => {
    ...
    function ladeDaten(xhr, args, message) {
